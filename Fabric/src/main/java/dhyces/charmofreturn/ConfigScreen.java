...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen(Screen parent) {
        super(new TranslatableComponent("config_screen.charmofreturn.title"));
        this.parent = parent;
    ...
    protected void init() {
        super.init();
        addRenderableWidget(
                new Button((width / 2) - 75, height - 50, 50, 20, new TranslatableComponent("config_screen.charmofreturn.save"),
                        button -> holder.save()
                )
        );
        addRenderableWidget(new Button((width / 2), height - 50, 50, 20, new TranslatableComponent("config_screen.charmofreturn.close"),
                button -> this.minecraft.setScreen(parent))
        );

        addRenderableWidget(new ConfigEditBox(font, 50, 50, 200, 20, new TranslatableComponent("config_screen.charmofreturn.level_cost_expression"),
                box1 -> {
        ...
        addRenderableWidget(new ConfigEditBox(font, 50, 80, 200, 20, new TranslatableComponent("config_screen.charmofreturn.durability"),
                box1 -> this.holder.durability = box1.parseIntValue()
                , "0")
        );
        addRenderableWidget(new ConfigEditBox(font, 50, 110, 200, 20, new TranslatableComponent("config_screen.charmofreturn.charge_ticks"),
                box1 -> this.holder.charge = box1.parseIntValue()
                , "200")
        );
        addRenderableWidget(new ConfigEditBox(font, 50, 140, 200, 20, new TranslatableComponent("config_screen.charmofreturn.cooldown_ticks"),
                box1 -> this.holder.cooldown = box1.parseIntValue()
                , "1200")
        );
        addRenderableWidget(new ConfigEditBox(font, 50, 170, 200, 20, new TranslatableComponent("config_screen.charmofreturn.is_client_only_particles"),
