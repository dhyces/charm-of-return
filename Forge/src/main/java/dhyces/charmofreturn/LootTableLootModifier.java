...
public class LootTableLootModifier extends LootModifier {
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        LootContext lootContext = new LootContext.Builder(context).withQueriedLootTableId(lootTableId).create(lootTableId);
        context.getResolver().getLootTable(lootTableId).getRandomItems(lootContext, generatedLoot::add);
